...
const initialState: covidState = {
	data: {
		...
		lastUpdate: '2021-02-28T08:23:06.000Z',
	},
...
const covidSlice = createSlice({
	...
	extraReducers: (builder) => {
		builder.addCase(fetchAsyncGet.fulfilled, (state, actiosn) => {
			return {
				...state,
				data: actiosn.payload,
			}
		})
		builder.addCase(fetchAsyncGetDaily.fulfilled, (state, actiosn) => {
			return {
				...state,
				dailyData: actiosn.payload,
			}
		})
		builder.addCase(fetchAsyncGetCountry.fulfilled, (state, actiosn) => {
			return {
				...state,
				data: actiosn.payload.data,
				country: actiosn.payload.country,
			}
		})
	},
})
